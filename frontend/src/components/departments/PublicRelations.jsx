...
const infoModalRef = useRef(null);
  ...
  try {
    const res = await axios.get(
      `${BASE_URL}/department-images?department=publicrelations&type=carousel`
    );
  ...
  const fetchContributions = async () => {
    try {
      const res = await axios.get(`${BASE_URL}/contributions?department=publicrelations`);
 ...
 const handleDeleteImage = (img) => {
  ...
  const confirmDeleteImage = async () => {
    try {
      ...
      await axios.delete(`${BASE_URL}/department-wise/delete-image/${deleteModalImage.id}?department=publicrelations&type=carousel`, {
  ...
  try {
    ...
    await axios.delete(
      `${BASE_URL}/contributions/delete/${deleteContributionId}?department=publicrelations`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
  ...
  const handleAddImages = async () => {
    try {
      ...
      formData.append("department", "publicrelations");
...
const deleteCarouselImage = async () => {
  try {
    ...
    await axios.delete(
      `${BASE_URL}/department-wise/delete-image/${deleteModalImage.id}?department=publicrelations&type=carousel`,
      {
        headers: {
...
const token = await user.getIdToken();
    try {
      await axios.delete(`${BASE_URL}/contributions/delete/${id}?department=publicrelations`, {
  headers: {
    Authorization: `Bearer ${token}`,
  },
});
